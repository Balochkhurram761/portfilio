  ...
  return (
   ...
   <div id='section2' className={` animate__animated  animate__backInLeft ${styles.section2}`}>
    ...
    <div className={styles.info}>
     ...
     <a href="public/cv/Khurram.pdf" download > <button>Download CV</button></a>
    </div>
   </div>
    </div>
  )
